  ...
  <div class="modal-dialog modal-dialog-centered registred-modal" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="userRegistredLable">افزودن کاربر</h5>
   ...
   <form wire:submit.prevent="create">
                  <div class="form-group">
                    ...
                    <input type="text" wire:model.defer="full_name" class="form-control @error('full_name') is-invalid @enderror">
                    @error('full_name')<div class="invalid-feedback"> {{$message}}</div>@enderror 
                  </div>

                  <div class="form-group">
                    <label for="email">آدرس ایمیل</label>
                    <input type="text" wire:model.defer="email" class="form-control @error('email') is-invalid @enderror">
                    @error('email')<div class="invalid-feedback"> {{$message}}</div>@enderror
                  </div>  

                  <div class="form-group">
                    <label for="company_name">نام شرکت</label>
                    <input type="text" wire:model.defer="company_name" class="form-control @error('company_name') is-invalid @enderror">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea wire:model.defer="address" class="form-control @error('address') is-invalid @enderror"></textarea>
